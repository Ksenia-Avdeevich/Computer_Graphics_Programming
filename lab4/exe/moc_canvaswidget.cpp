...
template <> constexpr inline auto CanvasWidget::qt_create_metaobjectdata<qt_meta_tag_ZN12CanvasWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'pointASelected'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'pointBSelected'
...
void CanvasWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->pointASelected(); break;
        case 1: _t->pointBSelected(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CanvasWidget::*)()>(_a, &CanvasWidget::pointASelected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (CanvasWidget::*)()>(_a, &CanvasWidget::pointBSelected, 1))
            return;
    }
}
...
// SIGNAL 0
void CanvasWidget::pointASelected()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void CanvasWidget::pointBSelected()
{
